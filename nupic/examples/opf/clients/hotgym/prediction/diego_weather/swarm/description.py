...
config = {
  ...
  u'wind':     {   'clipInput': True,
    ...
    'type': 'ScalarEncoder',
    'w': 21},
  u'is_daylight':     {   'clipInput': True,
    'fieldname': u'is_daylight',
    'maxval': 1,
    'minval': 0,
    'n': 100,
    'name': u'is_daylight',
...
control = {
  ...
  'dataset' : {   u'info': u'kw_energy_consumption',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'San Diego',
                            u'source': u'file://sd_weather.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'kwh',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'kwh', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'kwh', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
