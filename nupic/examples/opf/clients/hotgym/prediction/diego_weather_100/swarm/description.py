...
control = {
 ...
 u'predictionSteps': [1]},
  ...
  'metrics':[
    MetricSpec(field=u'kwh', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 72, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'kwh', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 72, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
