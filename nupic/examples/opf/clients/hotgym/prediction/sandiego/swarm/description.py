...
control = {
 ...
 u'predictionSteps': [1]},
  ...
  'metrics':[
    MetricSpec(field=u'kw_energy_consumption', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 24, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'kw_energy_consumption', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 24, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
