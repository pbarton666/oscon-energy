...
permutations = {
  ...
  u'kw_energy_consumption': PermuteEncoder(maxval=5.18, fieldName='kw_energy_consumption', w=21, clipInput=True, minval=0.0, encoderClass='ScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(maxval=5.18, classifierOnly=True, clipInput=True, minval=0.0, n=PermuteInt(28, 521), fieldname='kw_energy_consumption', w=21, type='ScalarEncoder', ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=24:field=kw_energy_consumption")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=24:field=kw_energy_consumption"
